...
Qualtrics.SurveyEngine.addOnload(function() {
    try {
        console.log('Starting Qualtrics script...');
        
        // Backend URL - Update this with your Render deployment URL
        const BACKEND_URL = 'ADD YOUR BACKEND URL FROM RENDER HERE'; // Your backend URL
        ...
        const htmlContent = `
            ...
            <div class="future-self-chat">
                ...
                <div class="finish-conversation" id="finish-section" style="display: none;">
                    ...
                    <button class="finish-btn">Complete Conversation</button>
                </div>
            </div>
        ...
        async function checkBackendConnection() {
            try {
                // Use the same pattern as the working script
        ...
        // Instead, after defining finishSection, add an event listener:
        const finishBtn = finishSection.querySelector('.finish-btn');
        if (finishBtn) {
        ...
        console.log('callFutureSelf type:', typeof callFutureSelf);

    } catch (error) {
        console.error('Error in Qualtrics script:', error);
